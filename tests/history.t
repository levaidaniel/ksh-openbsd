...
file-setup: file 644 "Env"
	PS1=X
perl-setup:
	system('(echo ls; sh -c \'while [[ $counter -lt 4096 ]];do echo -n c; counter=$(( counter + 1 ));done; echo; counter=0; while [[ $counter -lt 4096 ]];do echo -n d; counter=$(( counter + 1 ));done; echo\'; echo w) ' .
		'>>hist.file');
stdin:
	fc -l
expected-stdout:
